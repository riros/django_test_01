...
<!--<head>-->
    ...
    <!--&lt;!&ndash; bootstap &ndash;&gt;-->
    <!--<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css"-->
          <!--integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">-->
    <!--&lt;!&ndash; boostrap css &ndash;&gt;-->
    <!--<style>-->
...
<!--<div id="starting">-->
    <!--<div class="container">-->
        <!--<div class="row">-->
            <!--<h1>List of Articles-->
                <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addArticleModal">ADD-->
                    <!--ARTICLE-->
                <!--</button>-->
            <!--</h1>-->
            <!--&emsp;-->
            ...
            <!--</div>-->
            <!--&lt;!&ndash; End of add article modal &ndash;&gt;-->
            <!--&lt;!&ndash; Edit Article Modal &ndash;&gt;-->
            <!--<div class="modal fade" id="editArticleModal" tabindex="-1" role="dialog"-->
                ...
                <!--<div class="loading" v-if="loading===true">Loading&#8230;</div>-->
            <!--</div>-->
            <!--&lt;!&ndash; End of edit article modal &ndash;&gt;-->
